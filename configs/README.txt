...
substitutes.csv
	...
	1) For just CLI:
		1. Required fields: CLI, Substitute_CLI, & Substitute_Method
		2. Enter "CLI" for Substitute_Method field.

	2) For (CLI & CSID):
		1. Required fields: CLI, CSID, Substitute_CLI, Substitute_Method
		2. Enter "CLI_and_CSID" for Substitute_Method field.
